    ...
    e.fn.fullpage = function (l) {
        function s(n, t) {
            ...
            l.autoScrolling && !l.scrollBar ? (mt.css({
                ...
                "-ms-touch-action": "",
                "touch-action": ""
            }), at(0), o.length && mt.scrollTop(o.position().top))
        }
        ...
        function pe(n) {
            if (!kt.hasClass(f)) {
                Mt = !0, At = ne.height(), e(y).each(function () {
                    var n = e(this).find(V), t = e(this).find(R);
        ...
        function me() {
            ...
            var n = e(b).find(D);
            n.length && (0 !== e(b).index(y) || 0 === e(b).index(y) && 0 !== n.index()) && rt(n), Ln(), Qn(), "complete" === t.readyState && fn(), ne.on("load", fn)
        }

        function Se() {
            ne.on("scroll", Be).on("hashchange", un).blur(wn).resize(Mn), te.keydown(hn).keyup(vn).on("click touchstart", L + " a", yn).on("click touchstart", N, bn).on("click", O, pn), e(y).on("click touchstart", G, Sn), l.normalScrollElements && (te.on("mouseenter", l.normalScrollElements, function () {
                re(!1)
        ...
        function be() {
            kt.css({
                ...
                var t = e(this), o = t.find(R), i = o.length;
                Te(t, n), Ie(t, n), i > 0 ? xe(t, o, i) : l.verticalCentered && Vn(t)
            }), l.fixedElements && l.css3 && e(l.fixedElements).appendTo(St), l.navigation && Me(), Ee(), l.fadingEffect && wt.fadingEffect && wt.fadingEffect.apply(), l.scrollOverflow ? ("complete" === t.readyState && Le(), ne.on("load", Le)) : ze()
        }
        ...
        function Me() {
            ...
            for (var t = 0; t < e(y).length; t++) {
                ...
                "undefined" != typeof r && "" !== r && (i += '<div class="' + E + " " + l.navigationPosition + '">' + r + "</div>"), i += "</li>", n.find("ul").append(i)
            }
            e(L).css("margin-top", "-" + e(L).height() / 2 + "px"), e(L).find("li").eq(e(b).index(y)).find("a").addClass(p)
        }
        ...
        function Be() {
            ...
            if ((!l.autoScrolling || l.scrollBar || ft("dragAndMove")) && !ht()) {
                var i = ft("dragAndMove") ? o.abs(wt.dragAndMove.getCurrentScroll()) : ne.scrollTop(), r = De(i), a = 0, s = i + ne.height() / 2, c = ft("dragAndMove") ? wt.dragAndMove.getDocumentHeight() : St.height() - ne.height(), d = c === i, f = t.querySelectorAll(y);
                if (d)a = f.length - 1; else if (i)for (var u = 0; u < f.length; ++u) {
                    var h = f[u];
                    h.offsetTop <= s && (a = u)
                } else a = 0;
                if (Re(r) && (e(b).hasClass(g) || e(b).addClass(g).siblings().removeClass(g)), n = e(f).eq(a), !n.hasClass(p)) {
                    Zt = !0;
                    var v, m, S = e(b), w = S.index(y) + 1, x = Rn(n), C = n.data("anchor"), T = n.index(y) + 1, I = n.find(D);
                    I.length && (m = I.data("anchor"), v = I.index()), Et && (n.addClass(p).siblings().removeClass(p), e.isFunction(l.onLeave) && l.onLeave.call(S, w, T, x), e.isFunction(l.afterLoad) && l.afterLoad.call(n, C, T), rn(S), nn(n), tn(n), Bn(C, T - 1), l.anchors.length && (yt = C), Gn(v, m, C, T)), clearTimeout(Dt), Dt = setTimeout(function () {
                        Zt = !1
                    }, 100)
                }
                l.fitToSection && (clearTimeout(Pt), Pt = setTimeout(function () {
                    Et && l.fitToSection && (e(b).is(n) && (Mt = !0), Qe(e(b)), Mt = !1)
                }, l.fitToSectionDelay))
            }
        }
        ...
        function We(n) {
            ...
            if (!Fe(n.target) && Ze(t)) {
                ...
                Ut = a.y, Gt = a.x, i.find(V).length && o.abs(Nt - Gt) > o.abs(jt - Ut) ? !Ct && o.abs(Nt - Gt) > ne.outerWidth() / 100 * l.touchSensitivity && (Nt > Gt ? Ht.m.right && ue(i) : Ht.m.left && he(i)) : l.autoScrolling && Et && o.abs(jt - Ut) > ne.height() / 100 * l.touchSensitivity && (jt > Ut ? Pe("down", r) : Ut > jt && Pe("up", r))
            }
        }
        ...
        function Ne(t) {
            var i = (new Date).getTime(), r = e(m).hasClass(A);
            if (l.autoScrolling && !xt && !r) {
                ...
                var f = e(b), u = l.scrollOverflowHandler.scrollable(f), h = i - Xt;
                if (Xt = i, h > 200 && (Ot = []), Et && !ut()) {
                    var p = je(Ot, 10), v = je(Ot, 70), g = p >= v;
        ...
        function Ue(n, t) {
            var o = "undefined" == typeof t ? e(b) : t, i = o.find(V);
        ...
        function Ge(e, n) {
            var t = (n.find(R).length, n.find(D)), o = null;
        ...
        function qe(e) {
            var n = e.position(), t = n.top, o = ft("dragAndMove") ? wt.dragAndMove.isScrollingDown() : n.top > qt, i = t - At + e.outerHeight(), r = l.bigSectionsDestination;
        ...
        function en(n) {
            $e(n), e.isFunction(l.afterLoad) && !n.localIsResizing && l.afterLoad.call(n.element, n.anchorLink, n.sectionIndex + 1), l.scrollOverflowHandler.afterLoad(), l.resetSliders && wt.resetSliders && wt.resetSliders.apply(n), n.localIsResizing || tn(n.element), n.element.addClass(g).siblings().removeClass(g), Et = !0, e.isFunction(n.callback) && n.callback.call(this)
        }
        ...
        function sn() {
            if (t.domain.length) {
                var e = t.domain.split("."), n = (e.shift(), e.join("."));
                return n.replace(/(^\.*)|(\.*$)/g, "").replace(/^(www\.)/, "")
            }
            return ""
        }

        function cn(e) {
            var n = sn(), t = ["localhost", "127.0.0.1", "jshell.net", "UDdDQU5ZNlNN"], o = t[0], i = t[1], r = t[2], a = ln(t[3]), l = [o, i, r].indexOf(n) < 0 && 0 !== n.length, s = "undefined" != typeof Ft[e] && Ft[e].length;
            if (!s && l)return !1;
            var c = s ? ln(Ft[e]) : "";
            c = c.split("_");
        ...
        function un() {
            if (!Zt && !l.lockAnchors) {
                var e = n.location.hash.replace("#", "").split("/"), t = decodeURIComponent(e[0]), o = decodeURIComponent(e[1]), i = "undefined" == typeof yt, r = "undefined" == typeof yt && "undefined" == typeof o && !Ct;
        ...
        function bn(n) {
            n.preventDefault();
            var t = e(this).closest(y).find(V), o = t.find(R).eq(e(this).closest("li").index());
            Tn(t, o)
        }
        ...
        function Cn(e) {
            Et && (e.pageY < Qt && Ht.m.up ? se() : e.pageY > Qt && Ht.m.down && ce()), Qt = e.pageY
        }
        ...
        function Tn(n, t, o) {
            ...
            return r.xMovement = Dn(r.prevSlideIndex, r.slideIndex), r.localIsResizing || (Et = !1), l.onSlideLeave && !r.localIsResizing && "none" !== r.xMovement && e.isFunction(l.onSlideLeave) && l.onSlideLeave.call(r.prevSlide, r.anchorLink, r.sectionIndex + 1, r.prevSlideIndex, r.xMovement, r.slideIndex) === !1 ? void(Ct = !1) : (t.addClass(p).siblings().removeClass(p), r.localIsResizing || (rn(r.prevSlide), nn(t)), !l.loopHorizontal && l.controlArrows && (i.find(_).toggle(0 !== r.slideIndex), i.find(ee).toggle(!t.is(":last-child"))), i.hasClass(p) && Gn(r.slideIndex, r.slideAnchor, r.anchorLink, r.sectionIndex), wt.continuousHorizontal && wt.continuousHorizontal.apply(r), ht() ? In(r) : kn(n, r, !0), void(l.interlockedSlides && wt.interlockedSlides && wt.interlockedSlides.apply(r)))
        }

        function In(n) {
            wt.continuousHorizontal && wt.continuousHorizontal.afterSlideLoads(n), An(n.slidesNav, n.slideIndex), n.localIsResizing || (e.isFunction(l.afterSlideLoad) && l.afterSlideLoad.call(n.destiny, n.anchorLink, n.sectionIndex + 1, n.slideAnchor, n.slideIndex), Et = !0, tn(n.destiny)), Ct = !1, wt.interlockedSlides && wt.interlockedSlides.apply(n)
        }
        ...
        function kn(e, n, t) {
            ...
            if (l.css3) {
                ...
                En(e.find(F)).css(lt(r)), Rt = setTimeout(function () {
                    t && In(n)
        ...
        function Hn(n, t) {
            l.navigation && (e(L).find(v).removeClass(p), n ? e(L).find('a[href="#' + n + '"]').addClass(p) : e(L).find("li").eq(t).find("a").addClass(p))
        }
        ...
        function Fn(e, n) {
            n ? En(kt) : On(kt), kt.css(lt(e)), setTimeout(function () {
                kt.removeClass(d)
            }, 10)
        }
        ...
        function Yn(e, n) {
            var t = n.find(V), o = t.find(R + '[data-anchor="' + e + '"]');
        ...
        function Qn() {
            var n = e(b), t = n.find(D), o = qn(n), i = qn(t), r = String(o);
        ...
        function nt() {
            if (l.autoScrolling && (Tt || It)) {
                var n = ot();
                St.off("touchmove " + n.move).on("touchmove " + n.move, Ve), e(a).off("touchstart " + n.down).on("touchstart " + n.down, Ye).off("touchmove " + n.move).on("touchmove " + n.move, We)
            }
        }
        ...
        function at(e) {
            var n = o.round(e);
            if (l.scrollBar || !Wt.autoScrolling)mt.scrollTop(n); else if (l.css3) {
        ...
        function ct(n) {
            s(!1, "internal"), ae(!1), le(!1), kt.addClass(f), clearTimeout(Rt), clearTimeout(Bt), clearTimeout(zt), clearTimeout(Dt), clearTimeout(Pt), ne.off("scroll", Be).off("hashchange", un).off("resize", Mn), te.off("click touchstart", L + " a").off("mouseenter", L + " li").off("mouseleave", L + " li").off("click touchstart", N).off("mouseover", l.normalScrollElements).off("mouseout", l.normalScrollElements), e(y).off("click touchstart", G), ft("dragAndMove") && wt.dragAndMove.destroy(), clearTimeout(Rt), clearTimeout(Bt), n && dt()
        }
        ...
        function dt() {
            ...
            }), e(L + ", " + j + ", " + G).remove(), e(y).css({
                height: "",
                "background-color": "",
                padding: ""
            }), e(R).css({width: ""}), kt.css({
                height: "",
                position: "",
                "-ms-touch-action": "",
                "touch-action": ""
            ...
            }), On(kt), kt.find(I + ", " + F + ", " + V).each(function () {
        ...
        var mt = e("html, body"), St = e("body"), wt = e.fn.fullpage;
        l = e.extend({
            menu: !1,
            anchors: [],
            lockAnchors: !1,
        ...
        var yt, bt, xt, Ct = !1, Tt = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/), It = "ontouchstart" in n || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints, kt = e(this), At = ne.height(), Mt = !1, Lt = !0, Et = !0, Ot = [], Ht = {};
        Ht.m = {up: !0, down: !0, left: !0, right: !0}, Ht.k = e.extend(!0, {}, Ht.m);
        var zt, Bt, Rt, Dt, Pt, Vt, Wt = e.extend(!0, {}, l), Ft = {};
        vt(), oe.click = It, l.scrollOverflowOptions = e.extend(oe, l.scrollOverflowOptions), console.warn(l), e.extend(e.easing, {
            easeInOutCubic: function (e, n, t, o, i) {
                return (n /= i / 2) < 1 ? o / 2 * n * n * n + t : o / 2 * ((n -= 2) * n * n + 2) + t
            }
        }), e(this).length && (wt.setAutoScrolling = s, wt.setRecordHistory = U, wt.setScrollingSpeed = q, wt.setFitToSection = K, wt.setLockAnchors = J, wt.setMouseWheelScrolling = re, wt.setAllowScrolling = ae, wt.setKeyboardScrolling = le, wt.moveSectionUp = se, wt.moveSectionDown = ce, wt.silentMoveTo = de, wt.moveTo = fe, wt.moveSlideRight = ue, wt.moveSlideLeft = he, wt.reBuild = pe, wt.setResponsive = ve, wt.getFullpageData = ge, wt.destroy = ct, wt.landscapeScroll = Tn, we("continuousHorizontal"), we("scrollHorizontally"), we("resetSliders"), we("interlockedSlides"), we("responsiveSlides"), we("fadingEffect"), we("dragAndMove"), we("offsetSections"), ft("dragAndMove") && wt.dragAndMove.init(), me(), Se(), ft("dragAndMove") && wt.dragAndMove.turnOffTouch());
        var Zt = !1, Yt = 0, jt = 0, Nt = 0, Ut = 0, Gt = 0, Xt = (new Date).getTime(), qt = 0, Qt = 0, _t = At
